...
async function main() {
  ...
  `.split('\n').map(line => line.trim()).join('\n').trim();
    ...
    const testCharacter = await createItem(users.testwriter, publicUniverse, 'Test Character', 'test-character', 'character', defaultItemData.character(25, testParent, testChild));
